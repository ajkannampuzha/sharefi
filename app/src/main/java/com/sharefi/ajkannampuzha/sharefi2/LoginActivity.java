...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final String certificate="test";
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String data_string= URLEncoder.encode("email", "UTF-8")+"="+URLEncoder.encode(mEmail,"UTF-8")+"&"+
            ...
            //// TODO: 8/30/2016 Return true only if the server returns a valid certificate
            if(certificate!="test") {
                return true;
            }
            return false;
